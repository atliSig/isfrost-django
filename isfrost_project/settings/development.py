...
ROOT_URLCONF = 'isfrost_project.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                'isfrost_app.context_processors.company',
                'isfrost_app.context_processors.nav',
...
WSGI_APPLICATION = 'isfrost_project.wsgi.application'
